...
st.title("인공지능으로 파악한 동물들의 생김새 특징 탐구하기")
...
st.write(":pencil2: 다양한 특징을 기준으로 동물을 분류해보고 시각적 이미지로 인식할 수 있는 특징과 그렇지 않은 특징을 구분하는 과정을 통해, 컴퓨터의 시각 인식에 대한 기초적인 이해를 돕고 인공지능을 활용하여 해결할 수 있는 문제와 그렇지 않은 문제를 구분할 수 있도록 하고자 하였다.")
...
st.write(":pencil2: 시각적 이미지로 인식할 수 있는 특징과 그렇지 않은 특징을 포함하여, 다양한 기준으로 동물을 분류해보도록 지도한다.")
